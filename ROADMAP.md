...
| Задача | Статус |
|--------|--------|
| Вкладка "Application": PORT, WEBHOOK_SECRET, язык, формат даты | 🟡 План |
| Вкладка "Storage": выбор File/SQLite, миграция данных, статистика | 🟡 План |
| Вкладка "Notifications": SMTP, Telegram, Slack/Discord настройки | 🟡 План |
...
| Задача | Статус |
|--------|--------|
| Список провайдеров с типом (иконка), названием, URL, статусом | 🟡 План |
| Форма создания: тип, название, API URL, токен, default target, title prefix | 🟡 План |
| Кнопка "Test Connection" с индикацией успеха/ошибки | 🟡 План |
| Редактирование и удаление с подтверждением | 🟡 План |
| Маска токена (`••••••••`) | 🟡 План |
...
| Задача | Статус |
|--------|--------|
| Список лог-файлов: имя, размер, дата | 🟡 План |
| Просмотр содержимого (monospace, подсветка) | 🟡 План |
| Кнопки: "Download", "Delete" | 🟡 План |
| Кнопка "Clear All Logs" с confirm dialog | 🟡 План |
